...
//import com.collection.util.HostHolder;
...
//
//        if(tickets != null ){
//            UserToken loginTickets  = userTokenDao.selectByTicket(tickets);
//            if(loginTickets != null || loginTickets.getExpired().before(new Date()) || loginTickets.getStatus() != 0){
//
//                User user = userService.selectUserById(loginTickets.getUserId());
